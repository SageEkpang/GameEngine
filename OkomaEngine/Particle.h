...
private: // PRIVATE VARIABLE(s)
    ...
    OKVector2<float> pm_CalculatedDynamicFriction;
    OKVector2<float> pm_CalculatedStaticFriction;
...
protected: // PROTECTED VARIABLE(s)
    ...
    bool m_SimulateDynamicFriction = false;
    bool m_SimulateStaticFriction = false;
    ...
    bool m_DrawDynamicFriction = false;
...
public: // PUBLIC FUNCTION(s)
    ...
    OKVector2<float> ApplyDynamicFriction();
    OKVector2<float> ApplyStaticFriction();
    ...
    inline const OKVector2<float> GetDynamicFriction() { return m_DynamicFriction; }
    inline const OKVector2<float> GetStaticFriction() { return m_StaticFriction; }
    ...
    inline void SetDynamicFriction(float friction) { m_DynamicFriction = friction; }
    inline void SetStaticFriction(float friction) { m_StaticFriction = friction; }
};
