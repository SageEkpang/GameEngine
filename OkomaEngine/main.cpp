...
int main()
{
	...
	ParticleSystem* m_ParticleSystem = new ParticleSystem(OKVector2<float>(500, 400), ParticleAmount);
	{
		...
		m_ParticleSystem->SetEmitterOffset(OKVector2<float>(-100, 0));

		m_ParticleSystem->SetExecuteOnce(true);
		m_ParticleSystem->AssignParticleSpawnAreaCircle(10.f);
		m_ParticleSystem->SetEmissionRateOverTime(50u);
		m_ParticleSystem->SetStartSpeed(3.0);
		m_ParticleSystem->SetStartLifeTime(0.5f);

		m_ParticleSystem->AssignColourOverLifeTime(OKVector3<unsigned int>(200, 200, 200), OKVector3<unsigned int>(100, 100, 100));
		m_ParticleSystem->AssignResizeOverLifeTime(OKVector2<float>(10.f, 10.f), OKVector2<float>(1.f, 1.f));
	}
