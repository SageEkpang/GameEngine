...
TestScene::TestScene()
{
...

	{
		...
		m_CircleObjectTwo.GetComponent<Rigidbody2DComponent>()->ApplyImpulseX(-50);
...

	{
		...
		// m_ExtraObject.GetComponent<Rigidbody2DComponent>()->ApplyImpulseX(10);
		m_ExtraObject.AddComponent<RenderComponent>()->Construct(40.f, 40.f);
		m_ExtraObject.AddComponent<RectangleColliderComponent>()->Construct(40, 40);
