...
enum Collider_Type_Collisions
{
    ...
    COLLIDER_TYPE_COLLISIONS_RECTANGLE_TO_RECTANGLE, // Working

    COLLIDER_TYPE_COLLISIONS_CIRCLE_TO_CIRCLE, // Working
    COLLIDER_TYPE_COLLISIONS_CIRCLE_TO_RECTANGLE, // Working

    COLLIDER_TYPE_COLLISIONS_CAPSULE_TO_CIRCLE, // Working
    COLLIDER_TYPE_COLLISIONS_CAPSULE_TO_RECTANGLE, // Working
    COLLIDER_TYPE_COLLISIONS_CAPSULE_TO_CAPSULE, // Working
