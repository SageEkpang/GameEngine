...
{
    Vector2 DistanceBetweenPoints = Vector2Subtract(Vector2{other.m_Transform->position.x, other.m_Transform->position.y}, Vector2{m_Transform->position.x, m_Transform->position.y});
